...
st.markdown(text)
write_text("")
text = "Nos objectifs sont de concevoir les meilleurs modèles de classification, les comparer par rapport à leurs performances et de prédire au mieux la classe 1 en maximisant le nombre de vrais positifs et en minimisant le nombre de faux négatifs"
st.markdown(text)
write_text("")
